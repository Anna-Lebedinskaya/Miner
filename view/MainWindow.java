...
import ru.cft.focus.view.listener.CellEventListener;
...
public class MainWindow extends JFrame {
    ...
    public MainWindow(Controller controller) {
        ...
        setResizable(false);
        setIconImage(GameImage.BOMB_ICON.getImageIcon().getImage());
    ...
    public void createGameField(int rowsCount, int colsCount) {
        ...
        setPreferredSize(new Dimension(20 * colsCount + 70, 20 * rowsCount + 110));//размер всей программы
        ...
        setBombsCount(controller.getCountBombs());
    }
